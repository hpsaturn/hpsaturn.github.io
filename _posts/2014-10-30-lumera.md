...
<center><h1> Lumera - Kickstarter Project </h1></center>

<center><b>Kickstarter:</b> <a href="https://www.kickstarter.com/projects/hpsaturn/lumera-transform-your-camera-into-the-smartest-one" target="_blank">Lumera: transform your camera into the smartest one</a></center>

<a href="https://www.kickstarter.com/projects/hpsaturn/lumera-transform-your-camera-into-the-smartest-one" target="_blank"><img src="{{ '/assets/img/lumera_ks_video.jpg' | relative_url }}"></a>

## Technologies

We used the next technologies to do that:

- Android Java app (Only for demonstration)
- Gphoto2 - digital camera command-line client
- Arduino Framework, OpenWRT SDK, and others
- USB over IP
- Magic Lantern (Free software addon for Canon DLSR Cameras)
...
![Lumera]({{ '/assets/img/lumera_current_state.jpg' | relative_url }})
...
![Lumera]({{ '/assets/img/lumera_featured.jpg' | relative_url }})

## Features

{% capture images %}
  {{ '/assets/img/lumera_control.jpg' | relative_url }}
  {{ '/assets/img/lumera_mount.jpg' | relative_url }}
  {{ '/assets/img/lumera_gps.jpg' | relative_url }}
  {{ '/assets/img/lumera_usage.jpg' | relative_url }}
{% endcapture %}
{% include gallery images=images caption="Lumera Kickstarter" cols=2 %}

<div class="col-sm mt-3 mt-md-0">
  {% include video.liquid path="https://www.youtube.com/embed/1EgiiWQt3e4" class="img-fluid rounded z-depth-1" %}
</div>
