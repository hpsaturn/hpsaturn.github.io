...
{% capture images %}
  {{ '/assets/img/canairio_bike_header.jpg' | relative_url }}
{% endcapture %}
...
- PlatformIO and its continuous integration (CI)
...
<a href="https://play.google.com/store/apps/details?id=hpsaturn.pollutionreporter" target="_blank"><img src="{{ '/assets/img/gplayicon.png' | relative_url }}" align="right"></a>

### Android App

{% capture images %}
  {{ '/assets/img/canairio_app_track_preview.jpg' | relative_url }}
  {{ '/assets/img/canairio_app_mobile_station_settings.jpg' | relative_url }}
  {{ '/assets/img/canairio_app_fixed_station_settings.jpg' | relative_url }}
{% endcapture %}
...
{% capture images %}
  {{ '/assets/img/canairio_firmware_demo.gif' | relative_url }}
{% endcapture %}
{% include gallery images=images cols=1 %}
...
<a href="https://canair.io/docs/partners.html" target="_blank"><img src="{{ '/assets/img/canairio_partners_logos.jpg' | relative_url }}" align="center"></a>
...
{% capture images %}
  {{ '/assets/img/canairio_cos4cloud_members.jpg' | relative_url }}
{% endcapture %}
{% include gallery images=images cols=1 %}
...
<a href="{{ '/assets/img/my_qrcode_paypal_tip_jar.jpg' | relative_url }}" target="_blank"><img src="{{ '/assets/img/my_qrcode_paypal_tip_jar_tiny.jpg' | relative_url }}" align="right"></a>
...
{% capture images %}
  {{ '/assets/img/collage_canairio_community.jpg' | relative_url }}
{% endcapture %}
{% include gallery images=images cols=1 %}
