...
{% capture images %}
  {{ '/assets/img/hancel-screenshot01.jpg' | relative_url }}
  {{ '/assets/img/hancel-screenshot02.jpg' | relative_url }}
  {{ '/assets/img/hancel-screenshot03.jpg' | relative_url }}
  {{ '/assets/img/hancel-screenshot04.jpg' | relative_url }}
  {{ '/assets/img/hancel-screenshot-intro01.jpg' | relative_url }}
  {{ '/assets/img/hancel-screenshot-intro02.jpg' | relative_url }}
{% endcapture %}
