...
#### Verify Hostspot Subnet

```shell
nmcli con show Hostspot | grep ADDRESS
```
...
If you also needs that you hostspot runs under a VPN, you can install for instance [NordVPN](https://support.nordvpn.com/hc/en-us/articles/20226600447633-How-to-log-in-to-NordVPN-on-Linux-devices-without-a-GUI) that it has command line capability.

After the nordvpn installation, you also should need add some ports, like this:
...
If you wants command the on/off of your hostspot and also choose between different VPN cities or configs, you also could considerate add [RaspberryPi Launcher](https://github.com/hpsaturn/pilauncher/tree/master?tab=readme-ov-file#readme)
